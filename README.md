...
[![Build Status](https://travis-ci.org/mozilla-appmaker/map.png)](https://travis-ci.org/mozilla-appmaker/map)

A web component for [Appmaker](https://github.com/mozilla-appmaker/appmaker).

Appmaker import:
```
<link rel="import" href="/map">
```

# Test Status

See the github page http://mozilla-appmaker.github.io/map/ for test status.
...
Clone this repo:
```
git clone git@github.com:mozilla-appmaker/map.git
```
...
Your directory structure should look like this (more component repos can be cloned as siblings of `map`):
```
mozilla-appmaker/
  ├── appmaker/
  ├── map/
...
Enter the `map` directory, and install npm dependencies
```
cd map
npm install
```
